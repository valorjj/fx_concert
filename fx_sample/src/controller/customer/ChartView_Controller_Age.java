...
public class ChartView_Controller_Age implements Initializable {
	...
	//   XYChart.Series<String, Integer> series = null;
	   ...
	   public void initialize(URL arg0, ResourceBundle arg1) {
	      ...
	      int c_unique_no = Reservation_Concert_Select_Controller.concert_number;

	      XYChart.Series<String, Integer> series = new XYChart.Series<String, Integer>();
	      int age_10 = ReservationDao.get_reservationDao().get_reservation_by_age_10(c_no, c_unique_no);
	      int age_20 = ReservationDao.get_reservationDao().get_reservation_by_age_20(c_no, c_unique_no);
	      int age_30 = ReservationDao.get_reservationDao().get_reservation_by_age_30(c_no, c_unique_no);
	      int age_40 = ReservationDao.get_reservationDao().get_reservation_by_age_40(c_no, c_unique_no);
