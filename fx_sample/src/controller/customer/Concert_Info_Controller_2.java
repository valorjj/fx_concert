...
public class Concert_Info_Controller_2 implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		try {
			...
			Concert concert = ConcertDao.getConcertDao().get_concert_instance(2);

			// 날짜 정보도 불러옵니다. 3개이므로 리스트에 저장합니다.

			concert_date_list = ConcertDao.getConcertDao().get_concert_date_list(2);
