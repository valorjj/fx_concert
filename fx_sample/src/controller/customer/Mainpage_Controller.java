...
public class Mainpage_Controller implements Initializable {
	...
	@FXML
	public void btn_myinfo(ActionEvent event) {loadpage("personal_info_page");}

	// 버튼을 누르면 게시판으로 이동
	@FXML
	public void btn_board(ActionEvent event) {loadpage("board");}
	...
	@FXML
	public void btn_home(ActionEvent event) {loadpage("main_page_home");}
